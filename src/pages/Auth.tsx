...
const Auth = () => {
  ...
  const handleGoBack = () => {
    // This condition checks if there's a page in the browser's history stack to go back to.
    if (window.history.state && window.history.state.idx > 0) {
      // If there's a history, go back.
      navigate(-1);
    } else {
      // Otherwise, fallback to the homepage.
      navigate('/');
    }
  };
  ...
  return (
    <div className="min-h-screen bg-background">
      <Navbar />
      <Button variant="ghost" onClick={handleGoBack} className="mb-4 neon-border mt-10 md:mt-5 ml-5">
